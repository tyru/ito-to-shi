...
var _gameOver = require('./screen/gameOver.js');
...
var screenDispatcher = exports.screenDispatcher = function () {
  ...
  dispatcher.register(SCR_GAMEOVER, new _gameOver2.default());
  return dispatcher;
}();

},{"./screen/gameOver.js":5,"./screen/initial.js":6,"./screen/running.js":7,"./screen/selectMode.js":8,"./screenDispatcher.js":4,"./selection/needle.js":9}],4:[function(require,module,exports){
'use strict';
...
var ScreenDispatcher = function () {
  ...
  _createClass(ScreenDispatcher, [{
    ...
    value: function changeScreen(id) {
      // Clear timer
      if (_context.ctx.theTimer) {
        clearInterval(_context.ctx.theTimer);
        _context.ctx.theTimer = null;
      }
      ...
      // Call init functions
      if (screen.init) {
        _context.ctx.animateGlobal = false;
        screen.init();
        _context.ctx.animateGlobal = true;
      }
      // Update draw function
      if (screen.update && screen.getInterval) {
        _context.ctx.theTimer = setInterval(screen.update, screen.getInterval());
      }
...
},{"./context.js":3,"d3":2,"d3-jetpack":1}],5:[function(require,module,exports){
'use strict';
...
var GameOverScreen = function () {
  ...
  _createClass(GameOverScreen, [{
    ...
    key: 'touchStart',
    value: function touchStart() {
      (0, _context.initContext)(getInitVars(_context.selectedMode));
      drawGameOver(getGameOver());
      screenDispatcher.changeScreen(_context.SCR_RUNNING);
    }
  }, {
    key: 'touchEnd',
    value: function touchEnd() {}
...
},{"../context.js":3}],6:[function(require,module,exports){
'use strict';
...
var InitialScreen = function () {
  ...
  _createClass(InitialScreen, [{
    ...
    value: function init() {
      ...
      needleSelection.makeNeedles();
      needleSelection.drawNeedles(needleSelection.getNeedles());
...
var RunningScreen = function () {
  ...
  _createClass(RunningScreen, [{
    ...
    value: function init() {
      ...
      drawThread(getThread());
      _context.needleSelection.makeNeedles();
      _context.needleSelection.drawNeedles(_context.needleSelection.getNeedles());
      drawStatusText(getStatusText());
    }
  }, {
    key: 'update',
    value: function update() {
      ...
      _context.needleSelection.moveNeedles();
      var oldLevel = _context.ctx.level;
      doContinue = detectCollision() && doContinue;
      moveLevelUpText(oldLevel !== _context.ctx.level);
      // Update screen
      drawThread(getThread());
      _context.needleSelection.drawNeedles(_context.needleSelection.getNeedles());
      drawStatusText(getStatusText());
    ...
    key: 'getInterval',
    value: function getInterval() {
      return _context.THIRTY_FPS;
    }
  }, {
    key: 'touchStart',
    value: function touchStart() {
      _context.ctx.hovering = true;
    }
  }, {
    key: 'touchEnd',
    value: function touchEnd() {
      _context.ctx.hovering = false;
    }
  }]);
...
},{"../context.js":3}],8:[function(require,module,exports){
'use strict';
...
var SelectModeScreen = function () {
  ...
  _createClass(SelectModeScreen, [{
    ...
    key: 'touchStart',
    value: function touchStart() {
      if (_context.selectedMode !== '') {
        initContext(getInitVars(_context.selectedMode));
...
},{"../context.js":3}],9:[function(require,module,exports){
'use strict';
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // Manipulation methods for needles selection
...
var NeedleSelection = function () {
  ...
  _createClass(NeedleSelection, [{
    ...
    value: function makeNeedles() {
      ...
      var needleNum = Math.floor(_context.ctx.svgDS.width / _context.ctx.scoreMmMap[0][2] + 2);
      // First object is placed at 'ctx.svgDS.width'.
      var objX = _context.ctx.svgDS.width;
      for (var i = 0; i < needleNum; i++) {
        _context.ctx.needleGroupDS.push({
          x: objX,
          y: (0, _util.randNumBetween)(0, _context.ctx.svgDS.height - _context.ctx.scoreMmMap[0][1]),
          passed: false
        });
        this.needlePoleDS.push((0, _util.cloneObject)(_context.ctx.needlePoleDSTemplate));
        this.needleHoleDS.push((0, _util.cloneObject)(_context.ctx.needleHoleDSTemplate));
        objX += _context.ctx.scoreMmMap[0][2];
      }
    }
    ...
    value: function getNeedles() {
      return _context.$svg.selectAll('g.needle').data(_context.ctx.needleGroupDS);
    }
  }, {
    key: 'moveNeedles',
    value: function moveNeedles() {
      ...
      var thread = _context.ctx.threadDS[0];
      _context.ctx.needleGroupDS = _context.ctx.needleGroupDS.map(function (d, i) {
        if (d.x + _context.ctx.needleDx < _context.ctx.needleGapX) {
          // Next d.x is left of visible screen.
          (0, _util.assert)(willMove === -1, '0 <= moving needles <= 1');
          willMove = i;
        } else {
          d.x += _context.ctx.needleDx;
          d.animate = true;
        }
      ...
      if (willMove >= 0) {
        ...
        var nextLvScore = getScoreByLevel(_context.ctx.level + 1);
        var level = getCurrentScore() + rightsideNeedleNum >= nextLvScore ? _context.ctx.level + 1 : _context.ctx.level;
        var distanceX = getDistanceXByLevel(level);
        var mm = getMmByLevel(level);
        // Move the needle to the right.
        var needleGroupDS = _context.ctx.needleGroupDS[willMove];
        needleGroupDS.x = maxRightX + distanceX;
        needleGroupDS.y = (0, _util.randNumBetween)(0, _context.ctx.svgDS.height - mm);
        needleGroupDS.animate = false;
        needleGroupDS.passed = false;
        if (level > _context.ctx.level) {
          ...
          var nextNeedleNum = Math.floor(_context.ctx.svgDS.width / getDistanceXByLevel(_context.ctx.level + 1) + 2);
          (0, _util.assert)(nextNeedleNum >= _context.ctx.needleGroupDS.length, 'Lv.UP must not cause getMmByLevel() to be smaller number');
          if (nextNeedleNum > _context.ctx.needleGroupDS.length) {
            // Re-calculate the necessary number of needles.
            var necessaryNeedleNum = nextNeedleNum - _context.ctx.needleGroupDS.length;
            var objX = needleGroupDS.x + distanceX;
            for (var i = 0; i < necessaryNeedleNum; i++) {
              _context.ctx.needleGroupDS.push({
                x: objX,
                y: (0, _util.randNumBetween)(0, _context.ctx.svgDS.height - mm),
                passed: false
              });
              this.needlePoleDS.push((0, _util.cloneObject)(_context.ctx.needlePoleDSTemplate));
              this.needleHoleDS.push((0, _util.cloneObject)(_context.ctx.needleHoleDSTemplate));
    ...
    value: function drawNeedles($needles) {
      ...
      $needles.each(function (d) {
        ...
        _d2.default.select(this).transition().duration((0, _util.shouldAnimate)(d) ? _context.THIRTY_FPS : 0).attr('transform', 'translate(' + d.x + ',' + d.y + ')');
      });
...
},{"../context.js":3,"../util.js":10,"d3":2,"d3-jetpack":1}],10:[function(require,module,exports){
'use strict';
